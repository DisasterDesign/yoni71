...
export default function WhatsAppButton({ onClick }: { onClick: () => void }) {
  ...
  return (
    <motion.button
      onClick={onClick}
      className={`fixed bottom-6 left-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-lg transition-colors hover:bg-green-600 ${
