      ...
      <section className="bg-light py-20">
        <div className="mx-auto max-w-2xl px-4 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-3 rounded-full bg-green-600 px-8 py-4 text-lg font-bold text-white transition-all hover:bg-green-700 hover:shadow-lg"
          >
