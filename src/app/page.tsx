...
export default function Home() {
  ...
  return (
    <>
      {/* Hero */}
      <HeroSection onOrderClick={() => setIsModalOpen(true)} />
          ...
          <div className="mx-auto max-w-2xl px-4 text-center">
            ...
            <MagneticButton>
              <button
                ...
                className="animate-shimmer inline-flex items-center gap-3 rounded-full bg-green-600 px-6 py-3 text-base font-bold text-white transition-all hover:bg-green-700 hover:shadow-lg sm:px-8 sm:py-4 sm:text-lg"
              >
