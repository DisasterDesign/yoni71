...
import { ADDRESS_FULL, PHONE_1, PHONE_2, WHATSAPP_URL } from '@/lib/constants';
    ...
    <>
      ...
      <section className="bg-primary py-16">
        <div className="mx-auto max-w-7xl px-4 text-center">
          <h1 className="text-4xl font-black text-light sm:text-5xl">צור קשר</h1>
        </div>
      </section>
            ...
            >
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a
                  ...
                  className="flex items-center gap-2 rounded-full bg-green-600 px-5 py-2.5 text-sm font-bold text-white transition-colors hover:bg-green-700"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-bold text-light transition-colors hover:bg-dark"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 rounded-full bg-accent px-5 py-2.5 text-sm font-bold text-primary transition-colors hover:bg-accent/90"
                >
                  Waze
                </a>
              </div>
